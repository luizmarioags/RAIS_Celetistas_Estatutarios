...
$$
\mathcal{S} = \{ i : ativo_{i,31/12}=1,\; w_i > 0,\; regime_i \in \{celetista, estatutario\} \}.
$$

Para cada grupo $g$, o número de vínculos é:

$$
N_g = \sum_{i \in \mathcal{S}} \mathbf{1}\{i \in g\}.
$$
...
$$
Gap^{\%}_p = 100 \cdot \frac{\widehat{Q}_{est,p} - \widehat{Q}_{cel,p}}{\widehat{Q}_{cel,p}}.
$$
...
regime_i =
\begin{cases}
celetista, & tipo\_vinculo_i \in \{10,15,20,25,60,65,70,75\}, \\
estatutario, & tipo\_vinculo_i \in \{30,31,35,95,96,97\}, \\
outros, & tipo\_vinculo_i \in \{40,50,55,80,90\}, \\
tipo\_vinculo\_ausente, & tipo\_vinculo_i = \varnothing, \\
tipo\_vinculo\_nao\_mapeado, & \text{caso contrário.}
\end{cases}
$$
...
$$
regime_i \in \{celetista, estatutario\}.
$$
